...
class Container(Model):
    ...
    @property
    def ports(self): # -> Any | dict[Any, Any]:
        """
    ...
    def exec_run(self, cmd, stdout=..., stderr=..., stdin=..., tty=..., privileged=..., user=..., detach=..., stream=..., socket=..., environment=..., workdir=..., demux=...): # -> ExecResult:
        """
...
class ContainerCollection(Collection):
    model = Container
    def run(self, image, command=..., stdout=..., stderr=..., remove=..., **kwargs): # -> Model | bytes | None:
        """
    ...
    def list(self, all=..., before=..., filters=..., limit=..., since=..., sparse=..., ignore_removed=...): # -> list[Model | Unknown] | list[Unknown]:
        """
