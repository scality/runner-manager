...
class ImageCollection(Collection):
    model = Image
    def build(self, **kwargs): # -> Model | tuple[Model | Unknown, Iterator[Any]]:
        """
    ...
    def list(self, name=..., all=..., filters=...): # -> list[Model | Unknown]:
        """
    ...
    def load(self, data): # -> list[Model | Unknown]:
        """
    ...
    def pull(self, repository, tag=..., all_tags=..., **kwargs): # -> Model | list[Model | Unknown]:
        """
...
def normalize_platform(platform, engine_info): # -> dict[Unknown, Unknown]:
    ...
