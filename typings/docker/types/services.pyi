...
class TaskTemplate(dict):
    ...
    """
    def __init__(self, container_spec, resources=..., restart_policy=..., placement=..., log_driver=..., networks=..., force_update=...) -> None:
        ...
    
    @property
    def container_spec(self): # -> None:
        ...
...
class ContainerSpec(dict):
    ...
    Args:
        ...
        sysctls (:py:class:`dict`): A dict of sysctl values to add to
            the container
    """
    def __init__(self, image, command=..., args=..., hostname=..., env=..., workdir=..., user=..., labels=..., mounts=..., stop_grace_period=..., secrets=..., tty=..., groups=..., open_stdin=..., read_only=..., stop_signal=..., healthcheck=..., hosts=..., dns_config=..., configs=..., privileges=..., isolation=..., init=..., cap_add=..., cap_drop=..., sysctls=...) -> None:
        ...
...
class Mount(dict):
    ...
    """
    def __init__(self, target, source, type=..., read_only=..., consistency=..., propagation=..., no_copy=..., labels=..., driver_config=..., tmpfs_size=..., tmpfs_mode=...) -> None:
        ...
    
    @classmethod
    def parse_mount_string(cls, string): # -> Self@Mount:
        ...
...
class Resources(dict):
    ...
    """
    def __init__(self, cpu_limit=..., mem_limit=..., cpu_reservation=..., mem_reservation=..., generic_resources=...) -> None:
        ...
...
class UpdateConfig(dict):
    ...
    """
    def __init__(self, parallelism=..., delay=..., failure_action=..., monitor=..., max_failure_ratio=..., order=...) -> None:
        ...
...
def convert_service_ports(ports): # -> list[Unknown]:
    ...
...
class Privileges(dict):
    ...
    """
    def __init__(self, credentialspec_file=..., credentialspec_registry=..., selinux_disable=..., selinux_user=..., selinux_role=..., selinux_type=..., selinux_level=...) -> None:
        ...
