...
class ContextAPI:
    ...
    DEFAULT_CONTEXT = ...
    @classmethod
    def create_context(cls, name, orchestrator=..., host=..., tls_cfg=..., default_namespace=..., skip_tls_verify=...): # -> Context:
    ...
    @classmethod
    def set_current_context(cls, name=...): # -> None:
        ...
    ...
    @classmethod
    def inspect_context(cls, name=...): # -> dict[str, Unknown]:
