...
class ContainerApiMixin:
    ...
    def containers(self, quiet=..., all=..., trunc=..., latest=..., since=..., before=..., limit=..., size=..., filters=...): # -> list[dict[str, Unknown]]:
        """
    ...
    def create_container(self, image, command=..., hostname=..., user=..., detach=..., stdin_open=..., tty=..., ports=..., environment=..., volumes=..., network_disabled=..., name=..., entrypoint=..., working_dir=..., domainname=..., host_config=..., mac_address=..., labels=..., stop_signal=..., networking_config=..., healthcheck=..., stop_timeout=..., runtime=..., use_config_proxy=..., platform=...):
        """
...
"""
    ...
    @utils.check_resource('container')
    def logs(self, container, stdout=..., stderr=..., stream=..., timestamps=..., tail=..., since=..., follow=..., until=...): # -> CancellableStream:
        """
    ...
    @utils.check_resource('container')
    def update_container(self, container, blkio_weight=..., cpu_period=..., cpu_quota=..., cpu_shares=..., cpuset_cpus=..., cpuset_mems=..., mem_limit=..., mem_reservation=..., memswap_limit=..., kernel_memory=..., restart_policy=...):
        """
