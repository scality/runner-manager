...
class SwarmApiMixin:
    ...
    @utils.minimum_version('1.24')
    def init_swarm(self, advertise_addr=..., listen_addr=..., force_new_cluster=..., swarm_spec=..., default_addr_pool=..., subnet_size=..., data_path_addr=..., data_path_port=...):
        """
    ...
    @utils.minimum_version('1.24')
    def join_swarm(self, remote_addrs, join_token, listen_addr=..., advertise_addr=..., data_path_addr=...): # -> Literal[True]:
        """
    ...
    @utils.minimum_version('1.24')
    def update_swarm(self, version, swarm_spec=..., rotate_worker_token=..., rotate_manager_token=..., rotate_manager_unlock_key=...): # -> Literal[True]:
        """
