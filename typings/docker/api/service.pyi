...
class ServiceApiMixin:
    ...
    def create_service(self, task_template, name=..., labels=..., mode=..., update_config=..., networks=..., endpoint_config=..., endpoint_spec=..., rollback_config=...):
        """
        Create a service.
    ...
    @utils.check_resource('service')
    def service_logs(self, service, details=..., follow=..., stdout=..., stderr=..., since=..., timestamps=..., tail=..., is_tty=...):
        """
    ...
    @utils.minimum_version('1.24')
    @utils.check_resource('service')
    def update_service(self, service, version, task_template=..., name=..., labels=..., mode=..., update_config=..., networks=..., endpoint_config=..., endpoint_spec=..., fetch_current_spec=..., rollback_config=...):
        """
        Update a service.
