...
class APIClient(requests.Session, BuildApiMixin, ConfigApiMixin, ContainerApiMixin, DaemonApiMixin, ExecApiMixin, ImageApiMixin, NetworkApiMixin, PluginApiMixin, SecretApiMixin, ServiceApiMixin, SwarmApiMixin, VolumeApiMixin):
    ...
    """
    __attrs__ = ...
    def __init__(self, base_url=..., version=..., timeout=..., tls=..., user_agent=..., num_pools=..., credstore_env=..., use_ssh_client=..., max_pool_size=...) -> None:
        ...
    
    def get_adapter(self, url): # -> _BaseAdapter | UnixHTTPAdapter | NpipeHTTPAdapter | SSHHTTPAdapter | SSLHTTPAdapter:
        ...
